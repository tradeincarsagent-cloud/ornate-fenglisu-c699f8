...
function AboutPage() {
  return /* @__PURE__ */ jsx("main", { className: "min-h-screen bg-surface text-on-surface", children: /* @__PURE__ */ jsxs("section", { className: "mx-auto flex w-full max-w-4xl flex-col gap-8 px-margin-mobile py-14 md:px-margin-desktop md:py-20", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "font-headline-lg text-headline-lg md:text-display-lg text-primary-container", children: "About Trade in Cars Agent (TICA)" }),
      /* @__PURE__ */ jsx("p", { className: "font-body-md text-body-md text-on-surface-variant", children: "Built for Dealers. Powered by AI. Focused on Finding Better Vehicles." }),
      ...
      /* @__PURE__ */ jsx("p", { className: "font-body-md text-body-md text-on-surface-variant", children: "We believe the future of vehicle sourcing isn't about searching harder—it's about finding smarter." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-xl border border-outline-variant/30 bg-surface-container-low p-6 md:p-8", children: [
      /* @__PURE__ */ jsx("h2", { className: "font-headline-md text-headline-md text-primary-container", children: "OUR VISION" }),
      ...
      /* @__PURE__ */ jsx("p", { className: "font-headline-md text-headline-md md:text-headline-lg font-bold text-primary-container", children: "The Future Doesn't Search. It Finds." }),
      /* @__PURE__ */ jsx("p", { className: "font-body-sm text-body-sm text-on-surface-variant mt-2", children: "Welcome to the next generation of AI-powered vehicle sourcing." })
    ] }),
