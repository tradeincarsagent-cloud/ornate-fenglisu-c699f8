...
function PublicInfoCloseButton() {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      onClick: handleClose,
      type: "button",
      children: /* @__PURE__ */ jsx("svg", { "aria-hidden": "true", className: "h-5 w-5", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M6 6l12 12M18 6 6 18" }) })
    }
  );
}
export {
  PublicInfoCloseButton as P
};
