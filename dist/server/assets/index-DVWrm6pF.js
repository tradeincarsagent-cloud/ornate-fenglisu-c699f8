  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 max-md:py-14 bg-surface-container-low border-y border-outline-variant/10", id: "dashboard-preview", children: /* @__PURE__ */ jsxs("div", { className: "max-w-container-max mx-auto px-margin-desktop", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:hidden mb-5", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 min-[480px]:grid-cols-3 bg-surface-bright/10 border border-outline-variant/20 rounded-xl overflow-hidden backdrop-blur-md", children: [{
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:hidden mb-6 space-y-3", children: [{
          name: "BMW M3",
          score: "97%",
          profit: "+£3,200",
          certified: true
          ...
          profit: "+£1,850",
          certified: false
        }].map((row) => /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-xl border border-outline-variant/20 px-4 py-3 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-white font-semibold text-sm leading-tight", children: row.name }),
            /* @__PURE__ */ jsxs("p", { className: "text-on-surface-variant text-xs mt-0.5", children: [
              "AI Score: ",
              /* @__PURE__ */ jsx("span", { className: "text-white font-semibold", children: row.score }),
              /* @__PURE__ */ jsx("span", { className: "mx-1.5 opacity-40", children: "·" }),
              "Profit: ",
              /* @__PURE__ */ jsx("span", { className: "text-primary font-bold", children: row.profit })
            ] })
          ] }),
          row.certified && /* @__PURE__ */ jsx("span", { className: "shrink-0 text-[10px] text-primary font-bold uppercase tracking-wide border border-primary/40 rounded-full px-2 py-0.5", children: "🛡️ TICA™" })
        ] }, row.name)) }),
        /* @__PURE__ */ jsx("div", { className: "hidden lg:block glass-card rounded-2xl overflow-hidden border border-outline-variant/20 mb-12", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left font-body-md", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-6 mb-6 lg:mb-12", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "glass-card rounded-2xl border border-outline-variant/20 p-4 lg:p-7 h-full", children: [
            ...
            /* @__PURE__ */ jsxs("ul", { className: "lg:hidden space-y-1 font-mono text-xs", children: [
              [{
                ...
                value: "73"
              }].map((item) => /* @__PURE__ */ jsxs("li", { className: "flex items-baseline gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-on-surface-variant shrink-0", children: item.label }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-24 max-md:py-14 relative", id: "pricing", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-w-container-max mx-auto px-margin-desktop mt-8", children: /* @__PURE__ */ jsxs("div", { className: "trust-panel-card glass-card rounded-2xl border border-outline-variant/20", children: [
          /* @__PURE__ */ jsx("p", { className: "trust-panel-heading font-label-caps text-label-caps text-primary tracking-widest uppercase text-center mb-4", children: "Why Dealers Trust TICA" }),
          /* @__PURE__ */ jsx("ul", { className: "trust-panel-list grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-sm text-on-surface-variant", children: [{
            ...
            emphasized: false
          }].map((item) => /* @__PURE__ */ jsxs("li", { className: "trust-panel-item flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsx("svg", { className: "trust-panel-icon shrink-0 text-emerald-400", viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.707 7.293a1 1 0 0 0-1.414 0L10 14.586l-2.293-2.293a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.414 0l6-6a1 1 0 0 0 0-1.414z" }) }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 max-md:pt-10 max-md:pb-6 bg-surface-container-lowest border-y border-outline-variant/10", id: "version-2", children: /* @__PURE__ */ jsxs("div", { className: "max-w-container-max mx-auto px-margin-desktop", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center max-w-3xl mx-auto mb-16 max-md:mb-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-12 max-md:mt-4 glass-card rounded-2xl p-8 max-md:px-4 max-md:py-3.5 border border-outline-variant/20", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4 max-md:grid-cols-2 max-md:gap-2 max-md:[grid-auto-rows:1fr]", children: [{
            ...
            status: "Coming Soon",
            badgeClass: "bg-purple-500/20 text-purple-300"
          }].map((item) => /* @__PURE__ */ jsx("div", { className: "bg-surface-container p-4 max-md:px-2.5 max-md:py-3 rounded-xl border border-outline-variant/20 h-full max-md:flex max-md:flex-col max-md:items-center max-md:justify-center max-md:text-center max-md:gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 w-full max-md:flex-col max-md:items-center max-md:justify-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0 max-md:flex-col max-md:items-center max-md:gap-1.5 max-md:w-full", children: [
    ...
    /* @__PURE__ */ jsx("footer", { className: "bg-surface-container-lowest w-full py-20 max-md:py-14 border-t border-outline-variant/20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1200px] mx-auto px-margin-desktop grid grid-cols-1 md:flex md:flex-col md:items-center gap-12 md:gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-md:flex max-md:flex-col max-md:items-center max-md:gap-3 max-md:space-y-0 md:space-y-0 md:flex md:flex-col md:items-center md:gap-5", children: [
        /* @__PURE__ */ jsx("div", { className: "relative flex items-center justify-center max-md:w-full md:mb-0 md:justify-center", children: /* @__PURE__ */ jsx("div", { className: "logo-bezel rounded-lg p-1", children: /* @__PURE__ */ jsx("img", { alt: "Trade In Cars Agent Logo", className: "h-16 md:h-20 lg:h-24 w-auto object-contain logo-blend", src: "https://lh3.googleusercontent.com/aida-public/AB6AXuCKabmcvwQji3POw6DCSvZmOlFghhxBc4xSqvnkr647RPhuwklQMj0qzeFAToJIwomZJ_vSqpJW-nFPicV6qwiERTB5gIicgsv858anTVXqtchn1gMvh_dyWm1Wvc7fEF3NQhc_WF3zkfzaB76Awi-HDvQvgxUkHQXX42Rei9TPDQU5c2GXIrC7Szkpm32QDSGvg8ix3zOZ635ai7fd7NGDqKODHr0HGWrWxgUo7hH_0BD9-CO2cITGXq8W7O_fFnhhCyFwBCHWmVHG" }) }) }),
        /* @__PURE__ */ jsx("p", { className: "font-body-md text-body-md text-on-surface-variant max-w-sm max-md:max-w-[22rem] max-md:mx-auto max-md:text-center md:text-center", children: "An AI-assisted vehicle sourcing platform for dealers, traders and sourcing professionals." }),
