...
import { P as PlatformShell, T as TicaShield } from "./TicaShield-DdSB7UwX.js";
  ...
  return /* @__PURE__ */ jsx(PlatformShell, { navItems: [{
    ...
    /* @__PURE__ */ jsxs("section", { className: "mb-8 space-y-6 sm:space-y-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-2.5 sm:grid-cols-2 sm:gap-3 lg:grid-cols-3 xl:grid-cols-5", children: summaryCards.map((card, index) => /* @__PURE__ */ jsxs("article", { className: `dashboard-border flex min-h-[84px] flex-col justify-between rounded-xl bg-surface-container-high p-3.5 text-left sm:min-h-[120px] sm:p-4 sm:text-center md:min-h-[152px] md:p-5${index === 4 ? " sm:col-span-2 sm:mx-auto sm:w-[calc(50%-8px)] lg:col-span-1 lg:w-auto lg:mx-0" : ""}`, children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-[1.4rem] leading-tight font-bold text-primary md:mt-0 md:text-headline-lg md:font-headline-lg", children: card.value })
        ] }, card.title)) })
      ] }),
