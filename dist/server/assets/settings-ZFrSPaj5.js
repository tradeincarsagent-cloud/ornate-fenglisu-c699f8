...
function SettingsPage() {
  ...
  return /* @__PURE__ */ jsxs(PlatformShell, { navItems: [{
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-container-max space-y-5 sm:space-y-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 rounded-xl border border-primary/20 bg-primary/5 p-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-sm text-on-surface-variant", children: "These controls are in preview for now. Use them to define how TICA should prioritize opportunities and where to focus your buying strategy." })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "rounded-2xl border border-outline-variant/30 bg-surface-container-low p-4 sm:p-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-sm text-on-surface-variant", children: "Profile fields to begin teaching TICA how your dealership buys vehicles." }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "rounded-2xl border border-outline-variant/30 bg-surface-container-low p-4 sm:p-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-sm text-on-surface-variant", children: "Choose one premium profile so TICA can learn your preferred buying posture." }),
      ...
      /* @__PURE__ */ jsx("section", { className: "rounded-2xl border border-outline-variant/30 bg-surface-container-low p-4 sm:p-6", children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-primary/15 bg-linear-to-br from-primary/5 via-surface-container-high/60 to-surface-container p-4 sm:p-5", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-5 space-y-3", children: LEARNING_ITEMS.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-xl border border-outline-variant/25 bg-surface-container-high/50 px-4 py-3", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-on-surface-variant", children: "Coming Soon" })
        ] }, item)) }),
